...
{
{text = '✭ سورس ا ✭', url = 't.me/COURSE_elsayyadmarei '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/elsayyadmarei '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("@elsayyad36")
...
local TestText = "*✯ مبرمج سورس الصياد✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/elsayyad36"}
},
}
...
video = "https://t.me/h_o_sam/422"
local T = "*✭ مـرحـبا انـا صـانـع بـووتات حمايه\n✭ تم مبرجتيي من قبل المطورصياد/✭ للتنصيب الحمايه ارسل /n✭elsayyad او اتبع الازرار بالاسفل*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✭ المبرمج صياد ✭', url = 't.me/elsayyad36 '},
},
{  
{text = '✭سورس الصياد✭', url = 't.me/COURSE_elsayyad36 '},
},
}
local msgg = msg.id/2097152/0.5
...
photo = "https://t.me/COURSE_ELSAYYAD"
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝐂𝐀𝐄𝐒𝐀𝐑](t.me/COURSE_ELSAYYAD )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/elsayyad36 '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/elsayyad36'}, 
},
{
{text = '• قناة التحديثات •', url = 't.me/COURSE_ELSAYYAD '},
},
{  
{text = '• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐀𝐄𝐒𝐀𝐑 •', url = 't.me/COURSE_elsayyad36 '},
},
}
local msgg = msg.id/2097152/0.5
